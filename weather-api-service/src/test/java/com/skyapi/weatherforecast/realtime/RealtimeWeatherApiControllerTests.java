...
public class RealtimeWeatherApiControllerTests {
	...
	public void testUpdateShouldReturn404NotFound() throws Exception {
		...
		Mockito.when(realtimeWeatherService.update(Mockito.anyString(), Mockito.any())).thenThrow(LocationNotFoundException.class);
	...
	public void testUpdateShouldReturn200OK() throws Exception {
		...
		Mockito.when(realtimeWeatherService.update(Mockito.anyString(), Mockito.any())).thenReturn(realtimeWeather);
